...
const realInput = `.....487.599...........411...........................................574..679.136..........................30......255.......432............
....*......*............*..........&586..........................375...@..*....../.....835.............610*........./...............582.....
...
.664.598..`
	...
	assert.Equal(t, 4361, Solve(input, false))
}

func TestSolvePart1_EdgeCases(t *testing.T) {
	input := `..........
.......345
111.......
*........-
...
$.........`
	...
	assert.Equal(t, 146, Solve(input, false))
}

func TestSolvePart1_Real(t *testing.T) {
	assert.Equal(t, 525119, Solve(realInput, false))
}
...
...$.*....
.664.598..`
	assert.Equal(t, 467835, Solve(input, true))
}

func TestSolvePart2_Real(t *testing.T) {
	assert.Equal(t, 76504829, Solve(realInput, true))
}

func TestContainsSpecialCharacter(t *testing.T) {
	assert.True(t, ContainsSpecialCharacter([]rune("#!$%^&()*")))
	assert.False(t, ContainsSpecialCharacter([]rune(".........")))
	assert.False(t, ContainsSpecialCharacter([]rune("....345..")))
}

func TestExtractNumber(t *testing.T) {
	lines := []string{"..321.....", "..592....."}
	location := NumberLocation{y: 1, x: 2, length: 3}
	assert.Equal(t, 592, ExtractNumber(lines, location))
}

func TestExtractGearLocations(t *testing.T) {
	slice := []rune("..*.*...")
	expected := []GearLocation{
		{
			x: 5,
			y: 10,
		},
	...
	assert.Equal(t, expected, ExtractGearLocations(slice, 3, 10))
}

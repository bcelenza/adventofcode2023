...
func TestSolvePart1_Practice(t *testing.T) {
	input := "1abc2\npqr3stu8vwx\na1b2c3d4e5f\ntreb7uchet"
	assert.Equal(t, 142, SolvePart1(input))
}

func TestSolvePart1_Real(t *testing.T) {
	assert.Equal(t, 54573, SolvePart1(realInput))
}

func TestSolvePart2_Practice(t *testing.T) {
	input := "two1nine\neightwothree\nabcone2threexyz\nxtwone3four\n4nineeightseven2\nzoneight234\n7pqrstsixteen"
	assert.Equal(t, 281, SolvePart2(input))
}

func TestSolvePart2_GreedyOutsideIn(t *testing.T) {
	assert.Equal(t, 18, SolvePart2("oneight"))
